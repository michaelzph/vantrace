...
import type { Session, Event } from '@glassbox/core';
import { pad, formatDate, formatTime, revStr, formatActionData, riskColor } from './format.js';
...
export function SessionDetail({ session, events }: Props) {
  if (!session) {
